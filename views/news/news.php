					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<div class="row content_block">
								<div class="col-md-12 col-sm-12 box text-center">
								...
								<div class="col-md-12 col-sm-12 box text-center">
									<div class="flex_inner">
										<span class="h2"><?php echo $newsItem['short_content']; ?></span>
										<br>
										<br>
		    					...
		    					<div class="news_box">
		    						<div class="row">
		    							<div class="box_img">
		    								<a href="" >
		    									<img alt="" 
		    									src="/template/images/pic_4f252033175bd5854727c5aabea2b2a8.jpg">
		    								</a>
		    							</div>
		    						</div>
